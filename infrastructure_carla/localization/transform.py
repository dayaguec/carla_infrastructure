...
def dict_to_transform(dict_pos):
  """ 
  Parse from yalm dictionary to Carla transform.
  """
  return carla.Transform(carla.Location(x=dict_pos["x"], y=dict_pos["y"], z=dict_pos["z"]),\
    carla.Rotation(yaw=dict_pos["yaw"], pitch=dict_pos["pitch"], roll=dict_pos["roll"]))
...
def ros_transform_to_carla_transform(ros_transform):
  """
  Convert a ROS transform a carla transform.
  """
